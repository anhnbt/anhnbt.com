...
```
nohup java -jar blog-1.1.3-SNAPSHOT.jar --spring.profiles.active=prod > anhnbt-prod-1.1.3.log &
tail -1000f /opt/anhnbt-prod-1.1.3.log
nohup java -jar blog-1.1.2-SNAPSHOT.jar --spring.profiles.active=staging > anhnbt-staging.log &
```
